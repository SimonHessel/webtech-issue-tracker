...
export class EmailService {
  ...
  public async sendRegisterMail(username: string) {
    ...
    const mailOptions = {
      ...
      html: '<p>Hello '+username+'</p></br><p> Thank you for registering. To complete the registration process and verify your Account, click on this link: </br><a href='+link+'>Click here to verify</a></p>'
    };
  ...
  public async sendforgotPasswordMail(username: string) {
    ...
    const mailOptions = {
      ...
      html: '<p> Hey '+username+'. </p></br> <p> To reset your email please Click on this link: </br><a href='+link+'></a>Click here to reset Password </p>',
    };
  ...
  public async sendinvitedToAProjectMail(username: string, projectID: number) {
    ...
    const mailOptions = {
      ...
      html: '<p>Hey '+username+' you have been invited to a Project. Click on this link to get to it</br><a href='+link+'>Click here</a></p>',
    };
